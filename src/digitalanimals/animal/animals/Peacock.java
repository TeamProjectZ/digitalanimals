...
public class Peacock extends Animal {
	...
	public Peacock(AnimalEnum animanimalEnumalName) {
		this.setAge(0);
		this.setHealth(animanimalEnumalName.getHealth());
		this.setPrice(animanimalEnumalName.getPrice());
		this.setFoodType(animanimalEnumalName.getFoodType());		
	}
